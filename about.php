...
<section class="hero">
  ...
  <div class="card"><p><strong>Düsseldorf / Germany</strong></p><p>Chief Audit Executive<br><strong>Robert Breuss</strong></p><p><?= mmEscape($c['general']) ?>:<br><?= mmEmailLink('hello', 'E-Mail') ?></p><p><?= mmEscape($c['agency']) ?>:<br><?= mmEmailLink('agency', 'Agentur-Kontakt') ?></p><p><?= mmEscape($c['elite']) ?>:<br><?= mmEmailLink('eliteshopper', 'Elite-Shopper-Kontakt') ?></p></div>
</section>
