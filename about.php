...
mmHeader('About', 'MysteryMarket Audit & Field Services.');
?>
<section class="hero">
  <div>
    <p class="eyebrow">About</p>
    <h1>MysteryMarket</h1>
    <p class="lead"><strong>Independent Audit & Field Services</strong><br>Asset & Equipment Inspections · Brand Audits · Compliance Audits · Quality Assurance · Revenue Protection · Process & Field Audits · Mystery Audits · Mystery Visits</p>
  </div>
  <div class="card">
