...
<div class="definition"><strong>Kontakt</strong><div>E-Mail: <a href="mailto:<?= mmEscape((string)($legal['email'] ?? 'hello@mysterymarket.de')) ?>"><?= mmEscape((string)($legal['email'] ?? 'hello@mysterymarket.de')) ?></a></div></div>
