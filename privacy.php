...
'de'=>[
 ...
 'contact'=>'Das Kontaktformular verarbeitet Anfrageart, Name, Organisation, E-Mail, optionale Telefonnummer, Betreff und Nachricht. Die Daten werden ausschließlich zur Bearbeitung der jeweiligen Anfrage gespeichert. Zum Schutz vor automatisierten oder missbräuchlichen Formularübermittlungen kann die IP-Adresse mit einem serverseitigen Geheimnis pseudonymisiert gehasht und dieser Hash zusammen mit dem Zeitpunkt kurzfristig für das Rate-Limiting gespeichert werden; diese Einträge werden spätestens nach 24 Stunden entfernt. Allgemeine Anfragen werden über hello@mysterymarket.de bearbeitet. Rechtsgrundlage ist je nach Anfrage Art. 6 Abs. 1 lit. b oder f DSGVO.',
...
'en'=>[
 ...
 'contact'=>'The contact form processes enquiry type, name, organisation, email address, optional phone number, subject and message. Data is stored solely to handle the respective enquiry. To protect against automated or abusive submissions, the IP address may be pseudonymously hashed with a server-side secret and the resulting hash stored briefly with the timestamp for rate limiting; these records are removed after no more than 24 hours. General enquiries are handled via hello@mysterymarket.de. The legal basis is Art. 6(1)(b) or (f) GDPR, depending on the enquiry.',
...
'nl'=>[
 ...
 'contact'=>'Het contactformulier verwerkt type aanvraag, naam, organisatie, e-mailadres, optioneel telefoonnummer, onderwerp en bericht. De gegevens worden uitsluitend opgeslagen om de betreffende aanvraag te behandelen. Ter bescherming tegen geautomatiseerde of misbruikende verzendingen kan het IP-adres met een servergeheim gepseudonimiseerd worden gehasht en deze hash kort samen met het tijdstip voor rate limiting worden opgeslagen; deze gegevens worden uiterlijk na 24 uur verwijderd. Algemene vragen worden verwerkt via hello@mysterymarket.de. Rechtsgrond is afhankelijk van de aanvraag art. 6 lid 1 onder b of f AVG.',
