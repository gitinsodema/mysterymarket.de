...
'de'=>[
 ...
 'verify'=>'Bei der Prüfung einer Referenz wird der eingegebene Verifikationscode verarbeitet, um den Status eines Auditvorgangs anzuzeigen. Öffentliche Ergebnisse enthalten nur für die Veröffentlichung freigegebene Informationen. Vertrauliche Auftraggeber- oder Projektdaten werden nicht offengelegt.',
...
'en'=>[
 ...
 'verify'=>'When a reference is checked, the entered verification code is processed to display the status of an audit record. Public results contain only information approved for publication. Confidential client or project data is not disclosed.',
...
'nl'=>[
 ...
 'verify'=>'Bij het controleren van een referentie wordt de ingevoerde verificatiecode verwerkt om de status van een auditdossier te tonen. Openbare resultaten bevatten alleen informatie die voor publicatie is vrijgegeven. Vertrouwelijke klant- of projectgegevens worden niet bekendgemaakt.',
