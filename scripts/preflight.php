...
$required = [
    '.htaccess','VERSION','AI_START_HERE.md','docs/RELEASE_V1.md','docs/SECURITY_REVIEW_V1.md','docs/R1_1_RELEASE_REVIEW.md','docs/VERIFY_CREDENTIAL_WALLET_ARCHITECTURE.md','docs/APPLE_WALLET_RUNBOOK.md','docs/api/ATLAS_GEOGRAPHY_REFERENCE_API_V1.md','docs/coordination/README.md','docs/coordination/PRODUCT_HANDOFF.json',
    ...
    'lang/de.php','lang/en.php','lang/nl.php','scripts/verify-asset-bind.php','scripts/verify-record.php','scripts/data-maintenance.php','scripts/backoffice-user.php','scripts/backoffice-migrate.php','scripts/backoffice-review.php','scripts/credentials-review.php','scripts/wallet-readiness.php','scripts/wallet-package-review.php','scripts/r1.1-technical-gate.php','scripts/atlas-smoke.php','scripts/atlas-contract-inspect.php','scripts/atlas-street-inspect.php','scripts/build-web-artifact.sh','scripts/release-smoke.sh','scripts/final-review.sh',
