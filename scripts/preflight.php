...
$required = [
    ...
    'lang/de.php','lang/en.php','lang/nl.php','scripts/verify-asset-bind.php','scripts/verify-record.php','scripts/data-maintenance.php','scripts/build-web-artifact.sh','scripts/release-smoke.sh',
