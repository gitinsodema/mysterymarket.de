...
$required = [
    'index.php','services.php','audits.php','verify.php','tools.php','about.php','contact.php',
    'legal-notice.php','privacy.php','includes/site.php','includes/config.php','includes/db.php',
