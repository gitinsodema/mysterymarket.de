...
$required = [
    ...
    'public/css/style.css','public/media/hero-audit-office.svg','public/js/site.js','public/js/cookie-consent.js','public/js/verify-qr.js','public/js/backoffice-pwa.js','backoffice.webmanifest','backoffice-sw.js','public/vendor/qr-scanner/qr-scanner.min.js','public/vendor/qr-scanner/qr-scanner-worker.min.js','public/vendor/qr-scanner/LICENSE','public/vendor/qrcodejs/qrcode.min.js','public/vendor/qrcodejs/LICENSE','favicon.ico','robots.txt','sitemap.xml','database/schema.sql','database/20260830_backoffice_foundation.sql','database/20260830_backoffice_activation_tokens.sql','database/20260830_elite_membership_requests.sql','database/20260830_agencies.sql','database/20260830_elite_atlas_geography.sql','database/20260830_elite_work_profile.sql','database/20260830_credentials_foundation.sql','database/20260830_verify_credential_revision.sql','database/20260831_credential_access_binding.sql','database/20260828_contact_notification_status.sql','database/20260828_contact_reference_code.sql','database/20260828_contact_rate_limit.sql','database/20260828_verify_rate_limit.sql','database/20260828_verify_identity_assets.sql'
];
